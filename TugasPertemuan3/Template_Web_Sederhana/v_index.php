<section>
    ...
    <p align='justify'>Pada pengertian codeigniter di atas tadi di jelaskan bahwa codeigniter menggunakan metode MVC. 
        Apa itu 45 MVC? Kita juga harus mengetahui apa itu MVC sebelum masuk dan lebih 
        jauh dalam belajar codeigniter.</p>
    <p>MVC adalah teknik atau konsep yang memisahkan komponen utama menjadi tiga komponen yaitu model, 
        view dan controller.</p>
        <ol type="a">
            <li>Model</li>
    ...
    <p align='justify'>Dari penjelasan tentang model view dan controller 
        ...
        46 menangani bagian controller dan modelnya. Jadi pembagian tugas pun 
